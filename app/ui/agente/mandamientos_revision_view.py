...
class MandamientosRevisionView(QWidget):
    ...
    def __init__(self, agente_user: users_repo.User, parent=None, simulate: bool = False, dummy: bool = False):
        ...
        self._current_rows: list[revisiones_repo.RevisionRowMandamiento] = []
    ...
    def _on_import_revision(self) -> None:
        ...
        if self.dummy:
            ...
            self._current_rows = [
                revisiones_repo.RevisionRowMandamiento(
                    ...
                    fecha_citatorio=r.get("fecha_citatorio"), recibe_citatorio=r.get("recibe_citatorio"),
    ...
    def _on_export_revision(self) -> None:
        ...
        nombre = f"REVISION MANDAMIENTOS DE PRUEBA DEL {fecha}.xlsx" if self.dummy else f"REVISION MANDAMIENTOS DEL {fecha}.xlsx"
