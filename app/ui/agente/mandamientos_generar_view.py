...
from app.excel_io.mandamientos_export import build_agente_envelope, export_agente_backup_xlsx
    ...
    def _on_export(self) -> None:
        ...
        if self.simulate:
            ...
            proceed = QMessageBox.question(
                ...
                f"Se generará un archivo de prueba real (máximo {mandamientos_pdf.DUMMY_MAX_ROWS} "
            ...
            dummy_rows = self._rows[: mandamientos_pdf.DUMMY_MAX_ROWS]
